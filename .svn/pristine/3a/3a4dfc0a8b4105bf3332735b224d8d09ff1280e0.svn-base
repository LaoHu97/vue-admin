  ...
  <el-col :span="24" class="header">
    ...
    <el-col :span="4" class="userinfo">
      <el-dropdown trigger="hover">
        <span class="el-dropdown-link userinfo-inner"><img src="https://video47.oss-cn-beijing.aliyuncs.com/touxiang-01.gif" /> {{sysUserName}}</span>
...
export default {
  data() {
    return {
      sysName: require("../assets/logo.png"),
      collapsed: false,
      sysUserName: '',
      sysUserAvatar: '',
      form: {
