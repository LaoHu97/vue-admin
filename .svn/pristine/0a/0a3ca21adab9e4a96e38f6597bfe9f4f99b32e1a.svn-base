<template>
	<section>
		...
		<!--编辑界面-->
		<el-dialog title="请上传轮播图片" v-model="editFormVisible" :close-on-click-modal="false">
...
<script>
	...
	import { getUserListPage, formmodel, romveList, getNewmovies, getMoviesMessage, addImages, statusTopImages, updateResources } from '../../api/api';
